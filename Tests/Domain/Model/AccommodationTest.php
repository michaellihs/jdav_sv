...
/**
 * Testcase for class Tx_JdavSv_Domain_Model_Accommodation.
 *
 * @version $Id$
 ...
 */
class Tx_JdavSv_Domain_Model_AccommodationTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	...
	public function setUp() {
		$this->fixture = new Tx_JdavSv_Domain_Model_Accommodation();
	}
