...
/**
 * Testcase for class Tx_JdavSv_Domain_Model_Category.
 *
 * @version $Id$
 ...
 */
class Tx_JdavSv_Domain_Model_CategoryTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	...
	public function setUp() {
		$this->fixture = new Tx_JdavSv_Domain_Model_Category();
	}
